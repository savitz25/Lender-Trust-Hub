#!/usr/bin/env python3
"""
Deepen Washington HMDA product coverage (high-volume phase).

  python scripts/build-hmda-washington-deepen.py

Source: data/hmda/by-state/WA/
Writes: data/hmda/washington/*_wa.csv + lei_to_nmls_mapping.csv
Patches: lib/hmda/states.ts WA majorCountySlugs
"""
...
SRC = ROOT / "data" / "hmda" / "by-state" / "WA"
OUT = ROOT / "data" / "hmda" / "washington"
...
WA_MAJORS: set[str] = set(WA_COUNTIES.keys())
...
NATIONAL_SLUG_BY_NMLS: dict[str, str] = {
    ...
    "3274": "guild-mortgage-snohomish",
    "3029": "crosscountry-mortgage-snohomish",
    ...
    "1907": "veterans-united-snohomish",
    "1058": "lennar-mortgage-snohomish",
    "14622": "dhi-mortgage-buckeye",
    "399802": "bank-of-america-mortgage-snohomish",
    "2280": "21st-mortgage",
    "2143": "benchmark-mortgage",
    "3925": "kind-lending",
    "1904": "union-home-mortgage-reeves-team",
    "1561": "silverton-mortgage-snohomish",
    ...
    "402075": "sound-credit-union-south-sound",
    "411617": "iq-credit-union-vancouver",
    "401041": "whatcom-educational-credit-union",
    "409610": "becu-snohomish",
    "1591": "churchill-mortgage-nashville",
}

WA_CURATED_LEI: dict[str, dict[str, str]] = {
    # Nationals re-ID with WA host preference
    "549300HW662MN1WU8550": {
        ...
        "match_method": "wa_deepen_gleif_reidentify+public_nmls",
    },
    ...
    "549300AQ3T62GXDU7D76": {
        ...
        "nmls_id": "3274",
        "our_lender_slug": "guild-mortgage-snohomish",
        "legal_name": "Guild Mortgage Company LLC",
        "match_confidence": "high",
        "match_method": "wa_deepen_gleif_reidentify+wa_directory",
    },
    ...
    "549300VZVN841I2ILS84": {
        ...
        "nmls_id": "3029",
        "our_lender_slug": "crosscountry-mortgage-snohomish",
    ...
    "B4TYDEB6GKMZO031MB27": {
        ...
        "nmls_id": "399802",
        "our_lender_slug": "bank-of-america-mortgage-snohomish",
    ...
    "549300DD5QQUHO6PCH70": {
        ...
        "nmls_id": "1907",
        "our_lender_slug": "veterans-united-snohomish",
    ...
    "549300H3IZO24NSOO931": {
        ...
        "nmls_id": "1058",
        "our_lender_slug": "lennar-mortgage-snohomish",
    ...
    "5493000YNV8IX4VD3X12": {
        ...
        "nmls_id": "1561",
        "our_lender_slug": "silverton-mortgage-snohomish",
        "legal_name": "Vanderbilt Mortgage and Finance, Inc. (dba Silverton Mortgage)",
        "match_confidence": "high",
        "match_method": "wa_deepen_gleif+wa_directory+silverton_dba",
    },
    "549300RN01LBYR8ZVX74": {
        ...
        "match_confidence": "high",
        "match_method": "wa_deepen_gleif+public_nmls",
    },
    ...
    "549300KM40FP4MSQU941": {
        ...
        "match_confidence": "high",
        "match_method": "wa_deepen_gleif+wa_directory",
    },
    "54930060G4MDPWHISD89": {
        ...
        "match_confidence": "high",
        "match_method": "wa_deepen_gleif+lei_identity",
    },
    ...
    # Newly linked high-value WA regionals
    "549300N52O6FKUCU5G62": {
        "institution_name_hmda": "NUMERICA CREDIT UNION",
        "nmls_id": "",
        "our_lender_slug": "numerica-credit-union",
        "legal_name": "Numerica Credit Union",
        "match_confidence": "high",
        "match_method": "wa_deepen_gleif+wa_directory",
    },
    "5493000D6RXLNBZQYA47": {
        "institution_name_hmda": "COLUMBIA COMMUNITY CREDIT UNION",
        "nmls_id": "",
        "our_lender_slug": "columbia-community-credit-union",
        "legal_name": "Columbia Community Credit Union",
        "match_confidence": "high",
        "match_method": "wa_deepen_gleif+wa_directory",
    },
    "254900N49YI2HHKDPS92": {
        "institution_name_hmda": "IQ Credit Union",
        "nmls_id": "411617",
        "our_lender_slug": "iq-credit-union-vancouver",
        "legal_name": "iQ Credit Union",
        "match_confidence": "high",
        "match_method": "wa_deepen_gleif+wa_directory",
    },
    "5493003Q3L1PO9NBVK64": {
        "institution_name_hmda": "WHATCOM EDUCATIONAL CREDIT UNION",
        "nmls_id": "401041",
        "our_lender_slug": "whatcom-educational-credit-union",
        "legal_name": "Whatcom Educational Credit Union (WECU)",
        "match_confidence": "high",
        "match_method": "wa_deepen_gleif+public_nmls+wa_directory",
    },
    "549300P2GEYNMH5OQA71": {
        "institution_name_hmda": "WASHINGTON TRUST BANK",
        "nmls_id": "",
        "our_lender_slug": "washington-trust-bank",
        "legal_name": "Washington Trust Bank",
        "match_confidence": "high",
        "match_method": "wa_deepen_gleif+wa_directory",
    },
    "54930021QRU8VXNS6152": {
        "institution_name_hmda": "Sound Credit Union",
        "nmls_id": "402075",
        "our_lender_slug": "sound-credit-union-south-sound",
        "legal_name": "Sound Credit Union",
        "match_confidence": "high",
        "match_method": "wa_deepen_gleif+wa_directory",
    },
    "01KWVG908KE7RKPTNP46": {
        "institution_name_hmda": "HomeStreet Bank",
        "nmls_id": "",
        "our_lender_slug": "homestreet-bank",
        "legal_name": "HomeStreet Bank",
        "match_confidence": "high",
        "match_method": "wa_deepen_gleif+wa_directory",
    },
    "549300YEI60WAHWQ3110": {
        "institution_name_hmda": "KITSAP Credit Union",
        "nmls_id": "",
        "our_lender_slug": "kitsap-credit-union",
        "legal_name": "Kitsap Credit Union",
        "match_confidence": "high",
        "match_method": "wa_deepen_gleif+wa_directory",
    },
    "549300DK7QID2ZON6Q55": {
        ...
        "match_confidence": "high",
        "match_method": "wa_deepen_gleif+directory_slug",
    },
...
def fill_county(r: dict[str, str]) -> dict[str, str]:
    ...
    if not (r.get("county_name") or "").strip() and fips in WA_COUNTIES:
        return {**r, "county_name": WA_COUNTIES[fips]}
    return r
...
def load_prior_maps() -> dict[str, dict[str, str]]:
    ...
    for path in sorted((ROOT / "data" / "hmda").glob("*/lei_to_nmls_mapping.csv")):
        if "by-state" in str(path) or path.parent.name == "washington":
            continue
...
def patch_states_ts(major_slugs: list[str]) -> None:
    ...
    pattern = re.compile(
        r'(code: [\'"]WA[\'"],[\s\S]*?)majorCountySlugs: new Set\(\[[\s\S]*?\]\),',
        re.M,
    )
    m = pattern.search(text)
    if not m:
        raise SystemExit("Could not find WA majorCountySlugs in states.ts")
...
def main() -> None:
    ...
    for lei, cur in WA_CURATED_LEI.items():
    ...
    for r in county_rows:
        ...
        if not name and fips in WA_COUNTIES:
            r = {**r, "county_name": WA_COUNTIES[fips]}
            name = WA_COUNTIES[fips]
        if fips in WA_MAJORS or name or orig >= 650:
            if fips in WA_COUNTIES and not (r.get("county_name") or "").strip():
                r = {**r, "county_name": WA_COUNTIES[fips]}
            county_out.append(r)
    ...
    for r in read_csv(SRC / "lender_state_summary.csv"):
        ...
        if not (r.get("institution_name") or "").strip():
            ...
            if not nm and lei in WA_CURATED_LEI:
                nm = WA_CURATED_LEI[lei]["institution_name_hmda"]
            if nm:
    ...
    for r in cand:
        if "wa_originations" in r and col not in r:
            r[col] = r.get("wa_originations") or "0"
    ...
    def add_mapping(lei: str, base: dict[str, str], method_prefix: str) -> None:
        ...
        if method_prefix.startswith("wa_deepen") and curated_slug:
            slug = curated_slug
        else:
            slug = NATIONAL_SLUG_BY_NMLS.get(nmls) or curated_slug
        if not slug:
            return
        if not method_prefix.startswith("wa_deepen") and nmls in NATIONAL_SLUG_BY_NMLS:
        ...
        row = {
            ...
            "notes": (
                f"{method_prefix.rstrip('+') or 'curated'} map for WA activity "
                f"({st_orig} WA originations); slug={slug}."
            ),
        }
        prev = mapping_by_lei.get(lei)
        if prev and not method_prefix.startswith("wa_deepen"):
    ...
    if county_out:
        write_csv(OUT / "county_market_summary_wa.csv", county_out, list(county_out[0].keys()))
    if act_out:
        write_csv(OUT / "lender_activity_by_county_wa.csv", act_out, list(act_out[0].keys()))
    if state_rows:
        write_csv(OUT / "lender_state_summary_wa.csv", state_rows, list(state_rows[0].keys()))
    if cand:
        write_csv(OUT / "lei_mapping_candidates_wa.csv", cand, list(cand[0].keys()))
    if mapping_rows:
    ...
    major_named = [
        r
        for r in county_out
        if (r.get("county_fips") or "") in WA_MAJORS and (r.get("county_name") or "").strip()
    ]
    ...
    coverage = {
        ...
        "deferred_examples": [
            ...
            "Sunflower Bank",
            "Synergy One / Eastside Funding / Bay Equity",
        ],
        "notes": (
            "Expanded major-county panels to 28; GLEIF re-ID; prefer WA directory hosts; "
            "linked Numerica, Columbia Community CU, WECU, Washington Trust, HomeStreet, "
            "Kitsap CU, Sound CU, iQ CU."
        ),
    }
