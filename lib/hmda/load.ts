  ...
  return readCsvFile(cfg, 'lei_to_nmls_mapping.csv').map((r) => ({
    ...
    stateOriginations: num(
      r[cfg.originationsColumn] ??
        ...
        r.ohio_originations ??
        r.michigan_originations ??
        r.indiana_originations ??
        r.arizona_originations ??
        r.colorado_originations ??
        r.wisconsin_originations ??
        r.minnesota_originations ??
        r.missouri_originations ??
        r.kentucky_originations ??
        r.utah_originations ??
        r.nevada_originations ??
        r.oregon_originations ??
        r.washington_originations ??
        r.alabama_originations ??
        r.louisiana_originations ??
        r.iowa_originations ??
        r.kansas_originations ??
        r.nebraska_originations ??
        r.arkansas_originations ??
        r.mississippi_originations ??
        ...
        r.alaska_originations ??
        r.hawaii_originations ??
        r.north_dakota_originations ??
        r.south_dakota_originations
    ),
