...
export function compareLoanEstimates(
  ...
  const limitations = [
    ...
    'HMDA context, if shown, is 2025 multi-state market activity (47 product states including New Mexico and West Virginia) — not historical fee percentiles for these Loan Estimates.',
  ];
