...
export function compareLoanEstimates(
  ...
  const limitations = [
    ...
    'HMDA context, if shown, is 2025 multi-state market activity (13 product states including RI, VT, ME) — not historical fee percentiles for these Loan Estimates.',
  ];
