...
export function compareLoanEstimates(
  ...
  const limitations = [
    ...
    'HMDA context, if shown, is 2025 multi-state market activity (36 product states including Alabama and Louisiana) — not historical fee percentiles for these Loan Estimates.',
  ];
