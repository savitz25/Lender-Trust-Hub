/**
 * SHARE-002 — Lender Trust Hub social-share identity (repo-local).
...
export const SHARE_HUB = {
  ...
  host: 'www.lendertrusthub.com',
  apexHost: 'lendertrusthub.com',
  origin: 'https://www.lendertrusthub.com',
  ogImagePath: '/brand/lender-trust-hub-og.png',
  ogImageVersion: '20260821share002',
  ogWidth: 1200,
  ogHeight: 630,
  ogAlt: 'LenderTrustHub — lender research tools from the Ask Trust Hub Network',
