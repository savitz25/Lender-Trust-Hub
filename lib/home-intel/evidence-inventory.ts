...
export function assertPublicHomepageInventory(inventory: HomepageEvidenceMeasure[]): void {
  ...
  if (LENDER_HOMEPAGE_STATE_CARDS.length !== 8) throw new Error('Homepage must publish exactly the eight accepted state intelligence cards');
