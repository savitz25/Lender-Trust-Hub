...
type MeasureInput = Omit<HomepageEvidenceMeasure, 'display' | 'publicationStatus'> & {
...
export const LENDER_HOMEPAGE_STATE_CARDS: HomepageStateCard[] = [
  {
    ...
    sourceAsOf: `OFR roster ${FLORIDA_SNAPSHOT.licensing.source_as_of}; HMDA 2025; CFPB through ${FLORIDA_SNAPSHOT.cfpb.date_max}`,
  ...
  },
  {
    ...
    sourceAsOf: `${NEW_JERSEY_SNAPSHOT.source_as_of.hmda}; DOBI list ${NEW_JERSEY_SNAPSHOT.source_as_of.dobi_fi_list}`,
  ...
  },
  {
    ...
    sourceAsOf: `${CALIFORNIA_SNAPSHOT.source_as_of.hmda}; CalHFA directory retrieved 2026-09-03`,
  ...
  },
  {
    ...
    sourceAsOf: `${TEXAS_SNAPSHOT.source_as_of.hmda}; SML orders ${TEXAS_SNAPSHOT.source_as_of.sml_orders}`,
  ...
  },
  {
    ...
    sourceAsOf: `${WASHINGTON_SNAPSHOT.source_as_of.hmda}; DFI table retrieved 2026-09-04`,
  ...
  },
  {
    ...
    sourceAsOf: `${ARIZONA_SNAPSHOT.source_as_of.hmda}; CFPB retrieved 2026-09-04`,
