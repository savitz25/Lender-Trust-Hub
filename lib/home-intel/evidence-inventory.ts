...
export const LENDER_HOMEPAGE_STATE_CARDS: HomepageStateCard[] = [
  ...
  },
  {
    ...
    sourceClocks: [
      { label: 'HMDA vintage', sourceAsOf: '2025', retrievedAt: null },
      { label: 'FDIC overlay', sourceAsOf: ILLINOIS_SNAPSHOT.fdic.source_as_of, retrievedAt: ILLINOIS_SNAPSHOT.retrieved_at },
      { label: 'Current mortgage-company roster', sourceAsOf: null, retrievedAt: ILLINOIS_SNAPSHOT.retrieved_at },
    ],
