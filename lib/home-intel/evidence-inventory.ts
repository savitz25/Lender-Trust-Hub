...
export function assertPublicHomepageInventory(inventory: HomepageEvidenceMeasure[]): void {
  ...
  if (LENDER_HOMEPAGE_STATE_CARDS.length !== 7) throw new Error('Homepage must publish exactly the seven accepted state intelligence cards');
