...
import { fmtInt, fmtPct } from '@/lib/arizona-intelligence/snapshot';
...
export function ArizonaCountyTable({ counties }: { counties: County[] }) {
      ...
      <div className="min-w-0 overflow-x-auto">
        <table className="w-full min-w-[44rem] text-left text-sm">
          <caption className="sr-only">
            2025 HMDA activity for Arizona counties in this extract. Denial rate is not a quality
