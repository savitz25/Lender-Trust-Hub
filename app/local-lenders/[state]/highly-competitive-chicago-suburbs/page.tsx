...
import { HIGHLY_COMPETITIVE_CHICAGO_SUBURBS_HUB_AREAS, HIGHLY_COMPETITIVE_CHICAGO_SUBURBS_LENDER_SLUGS } from '@/lib/mortgage/illinoisLenders';
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.lendertrusthub.com/local-lenders/illinois/highly-competitive-chicago-suburbs' },
};
      ...
      <section className="lth-hero-wash border-b border-zinc-200 py-14 text-[#0A2540]">
        <div className="container mx-auto px-4 text-center">
          <p className="mb-3 inline-flex rounded-full border border-sky-400/40 bg-sky-500/10 px-4 py-1.5 text-sm">
            NMLS research directory · Chicago Suburbs · Collar Counties
          </p>
          ...
          <aside className="space-y-6">
            <div className="rounded-2xl border border-zinc-200 bg-white p-5 text-sm">
              ...
              <ul className="mt-3 space-y-2">
                ...
                <li><Link href="/local-lenders/illinois/central-illinois-affordability-gems" className="text-[#14B8A6] hover:underline">Central IL Hub →</Link></li>
