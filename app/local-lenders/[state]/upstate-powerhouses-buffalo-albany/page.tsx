...
} from '@/lib/mortgage/newYorkLenders';
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.lendertrusthub.com/local-lenders/new-york/upstate-powerhouses-buffalo-albany' },
};
      ...
      <section className="lth-hero-wash border-b border-zinc-200 py-14 text-[#0A2540]">
        <div className="container mx-auto px-4 text-center">
          <p className="mb-3 inline-flex rounded-full border border-orange-400/40 bg-orange-500/10 px-4 py-1.5 text-sm">
            NMLS research directory · Upstate Powerhouses · Buffalo &amp; Albany
          </p>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section>
              ...
              <p className="mt-4 text-sm">
                <Link href="/local-lenders/new-york/erie" className="text-[#059669] hover:underline">
            ...
            <section>
              ...
              <p className="mt-4 text-sm">
                <Link href="/local-lenders/new-york/albany" className="text-[#059669] hover:underline">
