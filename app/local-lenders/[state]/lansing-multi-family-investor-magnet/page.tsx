...
import { LANSING_MULTI_FAMILY_INVESTOR_MAGNET_HUB_AREAS, LANSING_MULTI_FAMILY_INVESTOR_MAGNET_LENDER_SLUGS } from '@/lib/mortgage/michiganLenders';
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.lendertrusthub.com/local-lenders/michigan/lansing-multi-family-investor-magnet' },
};
      ...
      <section className="lth-hero-wash border-b border-zinc-200 py-14 text-[#0A2540]">
        <div className="container mx-auto px-4 text-center">
          <p className="mb-3 inline-flex rounded-full border border-emerald-400/40 bg-emerald-500/10 px-4 py-1.5 text-sm">
            NMLS research directory · Lansing-East Lansing · Investor Magnet
          </p>
            ...
            <section>
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                {LANSING_MULTI_FAMILY_INVESTOR_MAGNET_HUB_AREAS.map((c) => (
                  <Link key={c.name} href={`/local-lenders/michigan/${c.slug}`}
          ...
          <aside className="space-y-6">
            <div className="rounded-2xl border border-zinc-200 bg-white p-5 text-sm">
              ...
              <ul className="mt-3 space-y-2">
                <li><Link href="/local-lenders/michigan/greater-detroits-value-pockets" className="text-[#14B8A6] hover:underline">Greater Detroit Hub →</Link></li>
                <li><Link href="/local-lenders/michigan/grand-rapids-fast-moving-core" className="text-[#14B8A6] hover:underline">Grand Rapids Hub →</Link></li>
                <li><Link href="/local-lenders/michigan/ann-arbor-kalamazoo-college-town-demand" className="text-[#14B8A6] hover:underline">Ann Arbor &amp; Kalamazoo Hub →</Link></li>
