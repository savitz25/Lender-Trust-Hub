...
import { SAN_ANTONIO_VALUE_PLAY_HUB_AREAS, SAN_ANTONIO_VALUE_PLAY_LENDER_SLUGS } from '@/lib/mortgage/texasLenders';
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.lendertrusthub.com/local-lenders/texas/san-antonio-value-play' },
};
      ...
      <section className="lth-hero-wash border-b border-zinc-200 py-14 text-[#0A2540]">
        <div className="container mx-auto px-4 text-center">
          <p className="mb-3 inline-flex rounded-full border border-amber-400/40 bg-amber-500/10 px-4 py-1.5 text-sm">
            NMLS research directory · Military &amp; Cash-Flow · Bexar County Focus
          </p>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section>
              ...
              <p className="mt-4 text-sm">
                <Link href="/local-lenders/texas/bexar" className="text-[#059669] hover:underline">
