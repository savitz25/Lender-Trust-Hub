...
export const metadata: Metadata = {
  ...
  description:
    'Paste key numbers from your Loan Estimate and see educational fee bands, APR/rate context, and 2025 Florida HMDA activity for matched lenders and counties. Free research tool — no lead form required.',
  alternates: {
...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Not yet. Our cleaned 2025 HMDA tables summarize applications, originations, denials, and product mix — not loan-level origination charge distributions. Fee placement uses published educational bands. When a matched lender or Florida county is selected, we show real HMDA volume and mix context separately.',
  },
  {
        ...
        <div className="container mx-auto px-4 py-10 md:py-14">
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <p className="mt-4 text-lg leading-relaxed text-zinc-600">
              ...
              when you select a matched lender or Florida county — real{' '}
