...
export const metadata: Metadata = {
  ...
  description:
    'Paste key numbers from your Loan Estimate and see educational fee bands, APR/rate context, and 2025 multi-state HMDA activity (42 product states including AR, MS, and OK) for matched lenders and counties. Free research tool — no lead form required.',
  alternates: {
